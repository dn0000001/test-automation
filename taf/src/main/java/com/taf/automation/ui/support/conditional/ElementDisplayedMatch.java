...
/**
 * Element Displayed matching class
 */
public class ElementDisplayedMatch implements Match {
    ...
    public boolean isMatch() {
        if (criteria == null || criteria.getCriteriaType() != CriteriaType.DISPLAYED) {
            return false;
        }
        ...
        try {
            ...
            if (element.isDisplayed()) {
                ...
                resultInfo.setCriteriaType(CriteriaType.DISPLAYED);
