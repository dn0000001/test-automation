...
/**
 * Element Unselected matching class
 */
public class ElementUnselectedMatch implements Match {
    ...
    public boolean isMatch() {
        if (criteria == null || criteria.getCriteriaType() != CriteriaType.UNSELECTED) {
            return false;
        }
        ...
        try {
            ...
            if (!element.isSelected()) {
                ...
                resultInfo.setCriteriaType(CriteriaType.UNSELECTED);
