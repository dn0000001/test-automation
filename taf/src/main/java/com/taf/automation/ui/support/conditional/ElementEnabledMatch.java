...
/**
 * Element Enabled matching class
 */
public class ElementEnabledMatch implements Match {
    ...
    public boolean isMatch() {
        if (criteria == null || criteria.getCriteriaType() != CriteriaType.ENABLED) {
            return false;
        }
        ...
        try {
            ...
            if (element.isEnabled()) {
                ...
                resultInfo.setCriteriaType(CriteriaType.ENABLED);
