...
/**
 * Element Attribute matching class
 */
public class ElementAttributeMatch implements Match {
    ...
    public boolean isMatch() {
        ...
        if (criteria.getCriteriaType() == CriteriaType.ATTRIBUTE_EQUALS
            ...
            try {
                ...
                String actual = element.getAttribute(getOptions().getAttribute()).trim();
                ...
                } else if (criteria.getCriteriaType() == CriteriaType.ATTRIBUTE_EQUALS_IGNORE_CASE) {
                    // Equals Ignore Case option
                    match = actual.equalsIgnoreCase(expected);
                } else if (criteria.getCriteriaType() == CriteriaType.ATTRIBUTE_REGEX) {
                    // Regular Expression option
                    match = actual.matches(expected);
                } else if (criteria.getCriteriaType() == CriteriaType.ATTRIBUTE_NOT_EQUAL) {
                    // Not Equal option
                    match = !actual.equals(expected);
                } else if (criteria.getCriteriaType() == CriteriaType.ATTRIBUTE_DOES_NOT_CONTAIN) {
                ...
                if (match) {
                    ...
                    resultInfo.getAdditionalInfo().put(ResultType.ATTRIBUTE, getOptions().getAttribute());
