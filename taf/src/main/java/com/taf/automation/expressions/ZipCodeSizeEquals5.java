...
/**
 * Expression that matches a zip code size of 5 against an address
 */
public class ZipCodeSizeEquals5 implements Expression {
    private static final String MATCHES = "ZIP5";
